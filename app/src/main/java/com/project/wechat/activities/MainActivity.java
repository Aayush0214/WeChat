...
import com.project.wechat.adapters.RecentConversationAdapter;
import com.project.wechat.databinding.ActivityMainBinding;
...
public class MainActivity extends BaseActivity implements ConversationListener {
              ...
              if (documentChange.getType() == DocumentChange.Type.ADDED) {
                  ...
                  for (int i = 0 ; i < conversations.size() ; i++) {
                      ...
                      if (conversations.get(i).senderId.equals(senderId) && conversations.get(i).receiverId.equals(receiverId)) {
                          ...
                          conversations.get(i).dateTime = getReadableDateTime1(documentChange.getDocument().getDate(Constants.KEY_TIMESTAMP));
                          break;
                      }
                  }
              }
    ...
    private String getReadableDateTime1(Date date) {
